        ...
        <>
            <div>
                <div className="mb-3">
                    ...
                    <textarea className="form-control" value={text} id="myBox" rows="8" onChange={handleOnChange} style = {props.mode === 'dark'? {background : 'grey',color : 'white'} : {background : 'white',color : 'black'}}>
